...
def create_listing_const_dict():     
    listing_const_dict = {}
    for listing_parent in listing_const:
        for listing in listing_parent[1]:
            listing_const_dict[listing[0]] = listing[1]
    return listing_const_dict

listing_const_dict = create_listing_const_dict()

if __name__ == "__main__":
    print listing_const_dict
